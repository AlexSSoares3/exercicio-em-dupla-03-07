...
let saldo = 3.50
let recarga = 20
let resultado = Number(saldo +  recarga);

console.log(`Este é seu saldo atual ${resultado}`);
...
/* ═══ EXERCÍCIO 4 — 🕵️ Texto que parece número ═══
   ...
   PREVISÃO DA DUPLA: linha 1 = _182_____  linha 2 = _string_____
...
let precoCorreto = 18
let resultado1 = Number(precoCorreto + 2);
console.log(`Resultado correto: ${resultado1}`);
console.log(typeof precoCorreto);
...
console.log(`Media do aluno na UC09: ${media} `);
